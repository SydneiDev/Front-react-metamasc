...
function WalletButton(_a) {
    ...
    var connectButtonText = function () {
        ...
        if (active) {
            return connectText || "".concat(account.substring(0, 5), "...").concat(account.substring(account.length - 5));
        }
        return buttonText || "Connect Wallet";
    };
    return (React.createElement(React.Fragment, null, Render ? (React.createElement("div", { onClick: function () {
            if (!active) {
                handleConnectClick();
            }
        } }, Render)) : (React.createElement(WalletbuttonButton, __assign({ onClick: function () {
            if (!active) {
                handleConnectClick();
            }
